...
class Contact extends Component {
    ...
    constructor(props){
        ...
        this.state = {
            ...
            contactType: 'Tel.',
            message: '',
            // we need to track both the value of all input fields and whether they have been updated
            // if this.state.input is updated, we'll set this.state.touched.input to true.
            touched: {
                firstname: false,
                lastname: false,
                telnum: false,
    ...
    handleInputChange(event){
        ...
        // checkbox is the only field where user input is in target.checked not target.value
    ...
    validate(firstname, lastname, telnum, email){
        ...
        if (this.state.touched.telnum && !reg.test(telnum)){
            ...
            errors.telnum = "Tel. Number Should not be over 11 numbers "
        }
        // split all chars in email up into array. Filter those that are @.
        // If len 0, no @, not valid email
